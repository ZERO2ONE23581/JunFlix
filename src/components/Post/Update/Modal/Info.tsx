import { SelectBtn } from './Info/Btn';
import styled from '@emotion/styled';
import { RemovePost } from './Info/Remove';
import { BlockComment } from './Info/Block';
import { Dispatch, SetStateAction } from 'react';
import { IPostUseform } from '../../../../types/post';
import { PostInputs } from '../../Create/Modal/Info/PostInputs';
